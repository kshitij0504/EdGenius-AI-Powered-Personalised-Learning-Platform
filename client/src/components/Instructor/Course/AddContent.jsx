...
//       >
//         <header className="lg:hidden sticky top-0 bg-gray-50 z-20">
//           <div className="flex items-center justify-between h-16 mt-[-20px]">
//             <button
//               onClick={() => setIsSidebarOpen(true)}
//               className="text-gray-600 hover:bg-gray-100 rounded-md p-2 transition-colors"
      ...
      >
        ...
        <div className="space-y-4">
          {courseData.chapters.map((chapter, chapterIndex) => (
            <div
              key={chapter.id}
              className="bg-[color:var(--color-card)] rounded-xl shadow-sm border border-[color:var(--color-card-border)] overflow-hidden transition-all duration-300 hover:shadow-md"
            >
              {/* Chapter Header */}
              <div className="px-6 py-4 bg-[color:var(--bg-dashboard-secondary)] border-b border-[color:var(--border-dashboard-light)]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4 flex-1">
                    <button
                      onClick={() => toggleChapter(chapter.id)}
