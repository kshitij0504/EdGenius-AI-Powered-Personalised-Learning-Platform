...
//   //       thumbnail: formData.thumbnailFile, // file object, not URL string
//   //     };
...
//         formDataObj.append("file", formData.thumbnailFile);

//         const uploadResponse = await axios.post(
//           "http://localhost:5000/api/upload", // 👈 make sure you have this API
//           formDataObj,
//           {
//             headers: {
...
//         thumbnailUrl = uploadResponse.data.url; // backend should return { url: "https://..." }
//       }

//       // Step 2: Create course with URL
//       const courseData = {
//         title: formData.title,
//         slug: formData.slug,
//         description: formData.description,
...
//         published: formData.published,
//         thumbnail: thumbnailUrl, // 👈 only URL is stored
//       };
...
//   //   try {
//   //     // // if you still want token for some reason
...
//   //       price: formData.price,
//   //       published: formData.published,
//   //       thumbnail: formData.thumbnailFile, // file object
//   //     };
    ...
    if (isEditing) {
      ...
      if (course) {
        setFormData({
          ...
          slug: course.slug,
          description: course.description,
          thumbnailFile: null, // keep empty for new upload
          category: course.category,
          price: course.price,
          published: course.published,
        });
