...
// //       Your AI Flow content goes here
// //     </div>
// //   </div>
// // );

// // const JourneySection = () => (
// //   <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-12 border border-gray-200">
// //     <h3 className="text-4xl font-bold text-center text-gray-800 mb-12">
// //       Journey Section
// //     </h3>
// //     <div className="text-center text-gray-600">
// //       Your Journey content goes here
// //     </div>
// //   </div>
// // );

// // const InfiniteTestimonialScroll = () => (
// //   <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-12 border border-gray-200">
// //     <h3 className="text-4xl font-bold text-center text-gray-800 mb-12">
// //       Testimonials
// //     </h3>
// //     <div className="text-center text-gray-600">
...
const MobilePhone = ({ scrollProgress }) => {
  // Optimized scroll-based transformations
          ...
          <div className="w-full h-full bg-white rounded-[5rem] relative overflow-hidden flex flex-col">
            ...
            <div className="absolute top-4 left-8 right-8 flex justify-between items-center text-gray-600 text-sm font-medium z-10">
              ...
              <div className="flex items-center space-x-2">
                <svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14.5 2.5L11.5 0V5L14.5 2.5Z" fill="currentColor"></path>
                  <path d="M11 0.5H10C9.4 0.5 9 1 9 1.5V6C9 6.5 9.4 7 10 7H11V0.5Z" fill="currentColor"></path>
                  <path d="M8.5 2.5H7.5C6.9 2.5 6.5 3 6.5 3.5V6C6.5 6.5 6.9 7 7.5 7H8.5V2.5Z" fill="currentColor" fillOpacity="0.8"></path>
                  <path d="M6 4H5C4.4 4 4 4.5 4 5V6C4 6.5 4.4 7 5 7H6V4Z" fill="currentColor" fillOpacity="0.6"></path>
                  <path d="M3.5 5.5H2.5C1.9 5.5 1.5 6 1.5 6.5V7H3.5V5.5Z" fill="currentColor" fillOpacity="0.4"></path>
                </svg>
                <svg width="25" height="12" viewBox="0 0 25 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="0.5" y="0.5" width="21" height="11" rx="2.67" stroke="currentColor" strokeWidth="1"></rect>
                  <rect x="23" y="3.5" width="1.5" height="5" rx="0.75" fill="currentColor"></rect>
                  <rect x="2" y="2" width="13.5" height="8" rx="1.33" fill="currentColor"></rect>
                </svg>
              </div>
            </div>
            ...
            <div className="flex-grow pt-20 px-6 pb-24 overflow-y-auto">
              ...
              <div className="relative text-center mb-6">
                ...
                <p className="text-gray-600 text-sm mb-1">Doubt-Solving Sessions</p>
                <h1 className="text-gray-800 text-7xl font-bold">3</h1>
              </div>

              <div className="text-center text-gray-600 text-sm mb-6">
                Next recommended lesson <span className="text-gray-800 font-semibold">Feb 24, 2025</span>
              </div>
              ...
              <div>
                <h3 className="text-gray-800 font-bold text-xl mb-4">AI-Generated Content</h3>
                <div className="space-y-3">
                  <div className="bg-gray-50/80 rounded-2xl p-4 flex items-center space-x-4 border border-gray-200">
                    <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-white" />
                    ...
                    <div className="flex-grow">
                      <p className="text-gray-800 font-semibold">Quiz: Data Structures</p>
                      <p className="text-gray-600 text-xs">AI-tailored for your level</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[#1a73e8] font-semibold">Start Now</p>
                      <p className="text-gray-600 text-xs">Feb 12, 2025</p>
                  ...
                  <div className="bg-gray-50/80 rounded-2xl p-4 flex items-center space-x-4 border border-gray-200">
                    ...
                    <div className="flex-grow">
                      <p className="text-gray-800 font-semibold">Lesson: Algorithms</p>
                      <p className="text-gray-600 text-xs">Adaptive difficulty</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[#1a73e8] font-semibold">Continue</p>
                      <p className="text-gray-600 text-xs">Feb 13, 2025</p>
                  ...
                  <div className="bg-gray-50/80 rounded-2xl p-4 flex items-center space-x-4 border border-gray-200">
                    ...
                    <div className="flex-grow">
                      <p className="text-gray-800 font-semibold">Practice: Coding</p>
                      <p className="text-gray-600 text-xs">Personalized exercises</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[#1a73e8] font-semibold">Begin</p>
                      <p className="text-gray-600 text-xs">Feb 14, 2025</p>
...
const LandingPage = () => {
  const [scrollY, setScrollY] = useState(0);
  const [visibleFeatures, setVisibleFeatures] = useState(new Array(6).fill(false));
  const featuresRef = useRef([]);
  ...
  const allFeatures = [
    {
      icon: <Target className="w-6 h-6" />,
      title: "Personalized Learning Goals",
      description: "AI analyzes your skill level and creates custom learning paths tailored to your objectives and pace.",
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "AI-Powered Assessments",
      description: "Dynamic quizzes adapt in real-time to challenge you at the perfect difficulty level.",
    },
    {
      icon: <BookOpen className="w-6 h-6" />,
      title: "Smart Content Generation",
      description: "Auto-generated lessons and examples that match your learning style and preferences.",
    },
    {
      icon: <MessageCircle className="w-6 h-6" />,
      title: "Intelligent AI Mentor",
      description: "24/7 AI assistant provides instant answers, guidance, and personalized learning support.",
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Advanced Analytics",
      description: "Track progress with deep insights to optimize your learning journey and identify strengths.",
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Collaborative Platform",
      description: "Connect with instructors and peers in an interactive, collaborative environment.",
    },
  ];
          ...
          <div className="text-center mt-32 relative z-10">
            <div className="flex items-center justify-center space-x-6 mb-10 flex-wrap gap-6">
              ...
              <div className="flex items-center space-x-3 bg-white/90 backdrop-blur-xl rounded-2xl px-6 py-4 border border-gray-200 hover:bg-white transition-colors shadow-lg hover:shadow-xl">
                ...
                <div>
                  <div className="text-gray-800 font-bold text-lg">Enterprise</div>
                  <div className="text-gray-600 text-sm">Ready</div>
                </div>
              </div>
            </div>
            <div className="inline-flex items-center justify-center space-x-8 bg-white/90 backdrop-blur-xl rounded-3xl p-8 flex-wrap gap-6 border border-gray-200 shadow-lg">
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#1a73e8] flex-shrink-0" />
                <span className="text-gray-700 font-semibold">No setup required</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#1a73e8] flex-shrink-0" />
                <span className="text-gray-700 font-semibold">AI-powered learning</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#1a73e8] flex-shrink-0" />
                <span className="text-gray-700 font-semibold">Instant progress tracking</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#1a73e8] flex-shrink-0" />
                <span className="text-gray-700 font-semibold">24/7 AI mentoring</span>
              </div>
            </div>
          </div>
        </div>
