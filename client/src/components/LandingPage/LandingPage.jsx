...
const MobilePhone = ({ scrollProgress, darkMode }) => {
  const yOffset = scrollProgress * 0.08;
  const xRotation = Math.min(scrollProgress * 0.003, 3);
  const yRotation = Math.sin(scrollProgress * 0.0001) * -2;
  const scale = Math.max(1 - scrollProgress * 0.00005, 0.99);
    ...
    >
      <div className="relative w-[480px] h-[920px] mx-auto">
        ...
        <div
          ...
          } rounded-[5.5rem] p-4 shadow-2xl border-2 ${
        ...
        >
          <div
            ...
            } rounded-[5rem] relative overflow-hidden flex flex-col`}
          >
            <div className="absolute top-5 left-1/2 transform -translate-x-1/2 w-36 h-8 bg-black rounded-full z-20 border border-gray-800"></div>
            <div
              className={`absolute top-4 left-8 right-8 flex justify-between items-center ${
                darkMode ? "text-gray-300" : "text-gray-600"
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div
                    ...
                    } rounded-2xl p-4 flex items-center space-x-4 border`}
                  >
                    <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-white" />
                    </div>
            ...
            <div
              ...
              } backdrop-blur-lg border-t rounded-b-[5rem]`}
            >
              <div className="flex justify-around items-center h-full px-6">
                <div
    ...
    >
        ...
        <div className="container mx-auto px-6 mt-20">
          ...
          >
            ...
            <div
              ...
              style={{ perspective: "2000px" }}
            >
              <MobilePhone scrollProgress={scrollY} darkMode={darkMode} />
            </div>
          ...
          <div className="text-center mt-32 relative z-10">
            <div className="flex items-center justify-center space-x-6 mb-10 flex-wrap gap-6">
              <div
                ...
                } backdrop-blur-xl rounded-2xl px-6 py-4 border transition-colors shadow-lg hover:shadow-xl`}
              >
                <div className="w-10 h-10 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl flex items-center justify-center">
                  <Star className="w-6 h-6 text-white" />
                </div>
            ...
            <div
              className={`inline-flex items-center justify-center space-x-8 ${
                darkMode
                  ...
                  : "bg-white/90 border-gray-200"
              } backdrop-blur-xl rounded-3xl p-8 flex-wrap gap-6 border shadow-lg`}
            >
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#1a73e8] flex-shrink-0" />
                <span
      ...
      <section className="relative z-10 py-20 lg:py-32">
        <div className="container mx-auto px-6">
          ...
          <div className="p-4 rounded-4xl">
            <AiFlowSection darkMode={darkMode} />
          </div>
          ...
          <div className="p-4 rounded-4xl">
            <InfiniteTestimonialScroll darkMode={darkMode} />
          </div>
