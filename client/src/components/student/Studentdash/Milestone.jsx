...
const MilestoneCard = ({ milestone, index }) => {
  ...
  return (
    <div
      className={`relative p-5 rounded-lg shadow-sm border ${
        isAchieved
          ? "bg-[var(--color-edgenius-bg-light)] border-[var(--color-edgenius-accent-medium)]"
          : "bg-[var(--color-edgenius-bg-light)] border-[var(--color-edgenius-accent-light)]"
      }`}
    >
      <div className="flex items-center mb-3">
        <IoRibbonOutline
      ...
      {isAchieved ? (
        ...
        <>
          ...
          <div className="w-full bg-[var(--color-edgenius-bg-light)] rounded-full h-2 mt-2">
            <div
...
const LearningMilestones = ({ milestones, xpPoints, level }) => {
  return (
    <section className="p-8 rounded-xl shadow-lg">
      <h3 className="text-3xl font-extrabold text-[var(--color-edgenius-accent-dark)] mb-7 flex items-center">
        <IoTrendingUpOutline className="text-[var(--color-edgenius-accent-medium)] mr-3 text-4xl" />
        Learning Milestones
      </h3>

      <div className="flex justify-between items-center bg-[var(--color-edgenius-bg-light)] p-5 rounded-lg mb-6 shadow-inner">
        <div className="text-center">
          <p className="text-[var(--color-edgenius-text-secondary)] text-sm">
            XP Points
          </p>
          <p className="text-3xl font-bold text-[var(--color-edgenius-accent-dark)] mt-1">
            {xpPoints}
          </p>
        </div>
        <div className="text-center">
