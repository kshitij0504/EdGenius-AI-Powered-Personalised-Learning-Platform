...
//     name: "Alex Johnson",
//     avatar: "https://ui-avatars.com/api/?name=Alex+Johnson&background=4f46e5&color=fff&size=128",
//     level: "Intermediate",
//     xp: 2480,
//     nextLevelXp: 3000,
//     streak: 12,
...
//       progress: 75,
//       thumbnail: "https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=600&h=300&fit=crop&crop=center",
//       duration: "6h 30m",
//       lessons: 24,
...
//       progress: 42,
//       thumbnail: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=600&h=300&fit=crop&crop=center",
//       duration: "8h 15m",
//       lessons: 32,
//       difficulty: "Beginner",
//       rating: 4.9,
...
//       progress: 15,
//       thumbnail: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=300&fit=crop&crop=center",
//       duration: "12h 45m",
//       lessons: 48,
//       difficulty: "Advanced",
//       rating: 4.7,
...
//     { id: 3, title: "Knowledge Master", icon: "🧠", earned: true, date: "Nov 10" },
//     { id: 4, title: "Speed Learner", icon: "⚡", earned: false, progress: 60 },
//     { id: 5, title: "Community Helper", icon: "🤝", earned: false, progress: 30 },
//   ]);

//   const getDifficultyColor = (difficulty) => {
//     switch (difficulty) {
//       case "Beginner": return "text-emerald-700 bg-emerald-100 border-emerald-200";
//       case "Intermediate": return "text-violet-700 bg-violet-100 border-violet-200";
...
//     switch (priority) {
//       case "high": return "border-l-red-500 bg-gradient-to-r from-red-50 to-red-50/50 border-red-100";
//       case "medium": return "border-l-violet-500 bg-gradient-to-r from-violet-50 to-violet-50/50 border-violet-100";
//       case "low": return "border-l-emerald-500 bg-gradient-to-r from-emerald-50 to-emerald-50/50 border-emerald-100";
//       default: return "border-l-gray-500 bg-gradient-to-r from-gray-50 to-gray-50/50 border-gray-100";
//     }
//   };
...
//         <div className="absolute -bottom-96 -left-96 w-[48rem] h-[48rem] bg-gradient-to-br from-emerald-500/8 via-teal-500/5 to-cyan-500/8 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "3s" }}></div>
//         <div className="absolute top-1/3 left-1/3 w-[32rem] h-[32rem] bg-gradient-to-br from-pink-500/5 via-rose-500/3 to-orange-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "6s" }}></div>
//       </div>

//       {/* Geometric Floating Elements - Edgenius Style */}
//       <div className="absolute top-20 left-20 w-3 h-3 bg-violet-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: "1s" }}></div>
//       <div className="absolute top-40 right-32 w-2 h-8 bg-emerald-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: "2s" }}></div>
//       <div className="absolute bottom-40 left-32 w-4 h-4 bg-orange-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: "3s" }}></div>
//       <div className="absolute top-60 right-20 w-6 h-2 bg-pink-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: "4s" }}></div>
...
//                   {!sidebarCollapsed && (
//                     <div>
//                       <h2 className="text-xl font-bold text-gray-800">EdgeGenius</h2>
...
//                 >
//                   <ChevronLeft className={`w-5 h-5 text-violet-600 transition-transform ${sidebarCollapsed ? "rotate-180" : ""}`} />
//                 </button>
//               </div>
...
//                     <div className="text-xs text-violet-600 font-medium">{user.xp} XP</div>
//                   </div>
//                   <div className="ml-2">
...
//                     </div>
//                     <p className="text-gray-600 text-lg mb-2">Ready to explore the edge of knowledge?</p>
...
//                           {user.xp}
//                         </div>
//                         <div className="text-sm text-gray-600 mt-1">Edge Points</div>
//                       </div>
//                     </div>
//                     <div className="flex-1 lg:max-w-md lg:ml-12">
//                       <div className="flex justify-between text-sm text-gray-600 mb-3">
//                         <span className="font-medium">Progress to Next Level</span>
//                         <span className="font-bold">{user.xp}/{user.nextLevelXp} XP</span>
//                       </div>
...
//                         </div>
//                       </div>
//                       <div className="text-xs text-gray-500 mt-2 text-center">{user.nextLevelXp - user.xp} XP to unlock Advanced level</div>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                     <div className="relative">
//                       <div className={`absolute -inset-0.5 bg-gradient-to-r ${stat.color} rounded-3xl blur opacity-0 group-hover:opacity-30 transition duration-300`}></div>
...
//                           <div className={`p-4 rounded-2xl bg-gradient-to-br ${stat.color} shadow-lg group-hover:shadow-xl transition-all transform group-hover:scale-110`}>
//                             <IconComponent className="w-7 h-7 text-white" />
//                           </div>
//                           <div className="text-right">
//                             <div className={`flex items-center px-3 py-1 rounded-full text-xs font-bold ${stat.bgColor} ${stat.textColor} border shadow-sm`}>
...
//                         </div>
//                         <div>
//                           <div className="text-3xl font-bold text-gray-800 mb-2 group-hover:text-gray-900 transition-colors">{stat.value}</div>
...
//                                 </button>
//                               </div>
//                               <div className={`absolute top-4 left-4 px-3 py-1 rounded-full text-xs font-bold border backdrop-blur-sm ${getDifficultyColor(course.difficulty)}`}>
//                                 {course.difficulty}
//                               </div>
//                               <div className="absolute top-4 right-4 px-3 py-1 bg-black/50 backdrop-blur-sm text-white text-xs font-bold rounded-full">
//                                 {course.category}
//                               </div>
//                               <div className="absolute bottom-4 left-4 text-white text-sm font-medium">Last watched {course.lastAccessed}</div>
//                             </div>

//                             <div className="flex-1 p-8">
//                               <div className="flex flex-col lg:flex-row lg:justify-between mb-6">
//                                 <div className="flex-1 mb-6 lg:mb-0">
//                                   <h3 className="text-2xl font-bold text-gray-800 mb-3 group-hover:text-violet-600 transition-colors">{course.title}</h3>
//                                   <p className="text-gray-600 mb-4 flex items-center">
//                                     by <span className="font-semibold ml-1">{course.instructor}</span>
...
//                                   <span className="text-gray-700">Progress: {course.progress}%</span>
//                                   <span className="text-violet-600">Next: {course.nextLesson}</span>
//                                 </div>
...
//                         <span className="text-xs text-red-600 font-bold">{upcomingTasks.filter((task) => task.priority === "high").length} urgent</span>
//                       </div>
//                     </div>
...
//                         <div
//                           key={task.id}
//                           className={`group/task cursor-pointer p-4 rounded-2xl border-l-4 transition-all hover:shadow-lg transform hover:-translate-y-0.5 ${getPriorityColor(task.priority)}`}
//                         >
//                           <div className="flex items-start justify-between mb-3">
//                             <div className="flex items-center space-x-3">
//                               <div className={`p-2 rounded-lg ${task.priority === "high" ? "bg-red-100" : task.priority === "medium" ? "bg-violet-100" : "bg-emerald-100"}`}>
//                                 {getTypeIcon(task.type)}
//                               </div>
//                               <div>
//                                 <h4 className="text-base font-semibold text-gray-800 group-hover/task:text-violet-600 transition-colors">{task.title}</h4>
...
//                           }`}
//                         >
//                           <div className={`p-3 rounded-lg ${achievement.earned ? "bg-emerald-100" : "bg-gray-100"} mr-4`}>
//                             <span className="text-lg">{achievement.icon}</span>
//                           </div>
//                           <div className="flex-1">
//                             <h4 className="text-base font-semibold text-gray-800">{achievement.title}</h4>
//                             {achievement.earned ? (
